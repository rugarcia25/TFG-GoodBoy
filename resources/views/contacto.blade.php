...
@section('contenido')
<div class="bg-gray-50 dark:bg-gray-900 md:flex pt-10 md:justify-center md:items-center mt-5">
  <div class="container my-24 px-10 mx-auto">
        ...
        <div class="flex flex-wrap items-center">
          <div class="grow-0 shrink-0 basis-auto block w-full lg:flex lg:w-6/12 xl:w-4/12">
            <div class="map-container-2 w-full">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d190.372237413183!2d0.269963333729562!3d40.23228500000002!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1ses!2ses!4v1683721130582!5m2!1ses!2ses"
            ...
            <div class="flex flex-wrap pt-12 lg:pt-0">
              <div class="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 lg:w-full xl:w-6/12 px-3 md:px-6 xl:px-12">
                <div class="flex items-start">
                  ...
                  <div class="grow ml-6">
                    <p class="font-bold mb-1">Soporte técnico</p>
                    <p class="text-gray-500">soporte@goodboy.es</p>
                    <p class="text-gray-500">+34 659 42 37 48</p>
                  </div>
                </div>
              </div>
              <div class="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 lg:w-full xl:w-6/12 px-3 md:px-6 xl:px-12">
                <div class="flex items-start">
                  ...
                  <div class="grow ml-6">
                    <a href="https://www.paypal.com/es/home" class="font-bold mb-1">Donación</a>
                    <p class="text-gray-500">donaciones@goodboy.es</p>
                    <p class="text-gray-500">Paypal</p>
                  </div>
                </div>
              </div>
              <div class="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 lg:w-full xl:w-6/12 px-3 md:px-6 xl:px-12">
                <div class="flex align-start">
                  ...
                  <div class="grow ml-6">
                    ...
                    <p class="text-gray-500">Calle Timo 5, Alcoceber</p>
                    <p class="text-gray-500">12579, Alcalá de Chivert</p>
                  </div>
                </div>
              </div>
              <div
                ...
                <div class="flex align-start">
                  ...
                  <div class="grow ml-6">
                    <p class="font-bold mb-1">Reportes de la web</p>
                    <p class="text-gray-500">reportes@goodboy.es</p>
                    <p class="text-gray-500">+34 659 42 37 48</p>
                  </div>
                </div>
              </div>
